...
(function(exports)
{
    ...
    var DiagramBuilder = {
        ...
        buildBidirectionalEdge: function(diagram, attribute){
            var fromEdge = this.buildEdge(diagram, [attribute[0], "normal", attribute[2], attribute[3], attribute[4]]);
            var toEdge = this.buildEdge(diagram, [attribute[0],   "normal", attribute[3], attribute[2], attribute[4]]);
