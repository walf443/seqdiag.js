  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_graph() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, id, s) { return ["graph", { "id": id, "stmt": s}]; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_edge_op() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return "asynchronus" })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column) { return "asynchronus_dotted" })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column) { return "return_asynchronus_dotted" })(pos0.offset, pos0.line, pos0.column);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column) { return "return_asynchronus" })(pos0.offset, pos0.line, pos0.column);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
