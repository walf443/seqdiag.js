  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_edge_op() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return "asynchronous" })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column) { return "asynchronous_dotted" })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column) { return "return_asynchronous_dotted" })(pos0.offset, pos0.line, pos0.column);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column) { return "return_asynchronous" })(pos0.offset, pos0.line, pos0.column);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
