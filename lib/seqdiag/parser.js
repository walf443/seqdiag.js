  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_edge_stmt() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, rhs, attr) { console.log( ["edge", rhs[0], id, rhs[1], attr]); return ["edge", rhs[0], id, rhs[1], attr]; })(pos0, result0[0], result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_edge_rhs() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, op, id) { return [op, id]; })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_edge_op() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "directed" })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset) { return "undirected" })(pos0);
          }
          if (result0 === null) {
            pos = pos0;
          }
